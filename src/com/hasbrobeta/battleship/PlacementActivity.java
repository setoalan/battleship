...
public class PlacementActivity extends Activity {
	...
	public void ship2(View vagina)
	{
		this.shipType = 0;
	}
	
	public void ship3d(View vagina)
	{
		this.shipType = 1;
	}
	
	public void ship3s(View vagina)
	{
		this.shipType = 2;
	}
	
	public void ship4(View vagina)
	{
		this.shipType = 3;
	}
	
	public void ship5(View vagina)
	{
		this.shipType = 4;
	}
	
	public void directionL(View vagina)
	{
	...
	public void directionR(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView4);
		tv.setText("Right");
        this.direction = 2;
	}
	public void directionU(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView4);
		tv.setText("Up");
        this.direction = 1;
	}
	public void directionD(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView4);
		tv.setText("Down");
        this.direction = 3;
	...
	public void letterCoordSelectA(View vagina)
	{
	...
	public void letterCoordSelectB(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("B");
        this.lcoord = 1;
	...
	public void letterCoordSelectC(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("C");
        this.lcoord = 2;
	...
	public void letterCoordSelectD(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("D");
        this.lcoord = 3;
	...
	public void letterCoordSelectE(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("E");
        this.lcoord = 4;
	...
	public void letterCoordSelectF(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("F");
        this.lcoord = 5;
	...
	public void letterCoordSelectG(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("G");
        this.lcoord = 6;
	...
	public void letterCoordSelectH(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("H");
        this.lcoord = 7;
	...
	public void letterCoordSelectI(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("I");
        this.lcoord = 8;
	...
	public void letterCoordSelectJ(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView1);
		tv.setText("J");
        this.lcoord = 9;
	...
	public void numberCoordSelect01(View vagina)
	{
	...
	public void numberCoordSelect02(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("2");
        this.ncoord = 1;
	...
	public void numberCoordSelect03(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("3");
        this.ncoord = 2;
	...
	public void numberCoordSelect04(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("4");
        this.ncoord = 3;
	...
	public void numberCoordSelect05(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("5");
        this.ncoord = 4;
	...
	public void numberCoordSelect06(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("6");
        this.ncoord = 5;
	...
	public void numberCoordSelect07(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("7");
        this.ncoord = 6;
	...
	public void numberCoordSelect08(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("8");
        this.ncoord = 7;
	...
	public void numberCoordSelect09(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("9");
        this.ncoord = 8;
	...
	public void numberCoordSelect10(View vagina)
	{
		TextView tv = (TextView) findViewById(R.id.textView3);
		tv.setText("10");
        this.ncoord = 9;
